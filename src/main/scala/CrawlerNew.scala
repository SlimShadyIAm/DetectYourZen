...
import slim.NewPythonicAnalysisSuite
...
object CrawlerNew extends App with CSVStats {

  val datadir = args(0)

  val projects = Source.fromFile("./sources_new.txt").getLines
